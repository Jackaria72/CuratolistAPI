...
class ChicagoUriBuilderTest {
    ...
    void testBuildChicagoUriBuildsCorrectUri() {
        ...
        String expected2 = "/artworks/search?query%5Bterm%5D%5Bis_public_domain%5D=true&fields=id,title,artist_title,date_start,date_end,date_display,image_id,is_public_domain,medium_display,dimensions,classification_title,place_of_origin,technique_titles&page=7&limit=100&q=cat";

        String results1 = uriBuilder.buildChicagoUri(1, null);
        String results2 = uriBuilder.buildChicagoUri(7, "cat");
